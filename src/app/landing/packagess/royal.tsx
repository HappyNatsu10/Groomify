    ...
    return (
        <>
            <div className='relative flex justify-between lg:flex-row flex-col w-full  gap-2.5'>
                <div className='bg-[url("/royaldog.avif")] lg:h-[419px] h-[350px] lg:w-[512px]  bg-cover bg-center rounded-2xl shadow-[0_7px_14px_0_rgba(0,0,0,0.04)] shadow-md'></div>
                <div className='p-[30px] border-1 border-[#58655b8e] rounded-2xl lg:w-[70%] shadow-[ 0 25px 50px -12px rgba(0,0,0,0.25)]'>
                    <div className='flex gap-1.5 items-center mb-2 z-10 justify-center p-[3px] border-1 border-[#58655b8e]  shadow-inner w-10 rounded-[5px]'>
